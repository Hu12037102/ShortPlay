...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  public List<DataBinderMapper> collectDependencies() {
    ...
    result.add(new com.example.module_login.DataBinderMapperImpl());
    result.add(new com.example.module_main.DataBinderMapperImpl());
    result.add(new com.example.module_play.DataBinderMapperImpl());
    return result;
  }
