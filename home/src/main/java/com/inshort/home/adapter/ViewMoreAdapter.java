...
import com.inshort.home.databinding.ItemViewMoreItemBinding;

import java.util.List;

public class ViewMoreAdapter extends BaseRecyclerAdapter<DramaSeriesEntity> {
    @Nullable
    ...
    public ViewMoreAdapter(@NonNull Context mContext, @NonNull List<DramaSeriesEntity> mData) {
        super(mContext, mData);
    }

    @Override
    public void onBindChildViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof ViewMoreAdapter.ViewHolder holder) {
    ...
    public RecyclerView.ViewHolder onCreateChildViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(ItemViewMoreItemBinding.inflate(LayoutInflater.from(getMContext()), viewGroup, false));
    }

    static class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemViewMoreItemBinding viewBinding;

        public ViewHolder(@NonNull ItemViewMoreItemBinding viewBinding) {
