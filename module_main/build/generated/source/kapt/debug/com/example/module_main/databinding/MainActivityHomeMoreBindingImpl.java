...
public class MainActivityHomeMoreBindingImpl extends MainActivityHomeMoreBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.atv_title, 4);
        sViewsWithIds.put(R.id.refresh_layout, 5);
        sViewsWithIds.put(R.id.rv_data, 6);
        sViewsWithIds.put(R.id.aiv_loading, 7);
    }
    // views
    @NonNull
    ...
    public MainActivityHomeMoreBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private MainActivityHomeMoreBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
